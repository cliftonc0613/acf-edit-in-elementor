 ...
 * Admin API class.
 */
class ACF_Edit_in_Elementor_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'acf-edit-in-elementor' ) . '" data-uploader_button_text="' . __( 'Use image', 'acf-edit-in-elementor' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'acf-edit-in-elementor' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'acf-edit-in-elementor' ) . '" />' . "\n";
